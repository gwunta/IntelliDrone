...
public final class Altimeter extends eu.hansolo.steelseries.gauges.AbstractRadial
{
    ...
    public eu.hansolo.steelseries.gauges.AbstractGauge init(final int WIDTH, final int HEIGHT)
    {
        if (isDigitalFont())
        {
            setLcdValueFont(LCD_DIGITAL_FONT.deriveFont(0.7f * WIDTH * 0.10f));            
        }
        else
        {
            setLcdValueFont(LCD_STANDARD_FONT.deriveFont(0.625f * WIDTH * 0.10f));       
        }
        ...
        {
            setLcdUnitFont(LCD_STANDARD_FONT.deriveFont(0.25f * WIDTH * 0.10f));
        }
        ...
        if (isLcdVisible())
        {
            ...
            LCD_DIM.setSize(WIDTH * 0.4, WIDTH * 0.1);
        } 
