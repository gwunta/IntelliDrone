...
public class TaskList
{
   ...
   /**Given a JXMapKit, for each task, paints a default marker onto the map provided representing the waypoint for each task.
    * 
    * @param map - The map to be populated with waypoint markers
    * @return - A JXMapKit with the containing the drawn markers
    */
   public JXMapKit plotCoords(JXMapKit map)
   {
       ...
       for(int i = 0; i<tasklist.size();i++) 
        {
            ...
            waypoints.add(new Waypoint(tempTask.getLat(),tempTask.getLong()));
        }     
